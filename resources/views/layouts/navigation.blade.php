            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        ...
                        :active="request()->routeIs('admin.slogan.index')"
                    >
                        {{ __('Slogan') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        ...
                        :active="request()->routeIs('admin.galeri.foto.index')"
                    >
                        {{ __('Galeri Foto') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        ...
                        :active="request()->routeIs('admin.profil.index')"
                    >
                        {{ __('Profil') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        ...
                        :active="request()->routeIs('admin.kelas.index')"
                    >
                        {{ __('Kelas') }}
                    </x-nav-link>
                </div>
